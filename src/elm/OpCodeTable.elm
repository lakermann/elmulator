...
opCodeTable =
    Dict.fromList
        ...
        , ( 0x12, OpCodeData "STAX D" 7 (OneByte MachineInstructions.stax_d) )
        ...
        , ( 0xB4, OpCodeData "ORA H" 4 (OneByte MachineInstructions.ora_h) )
        ...
        , ( 0xD2, OpCodeData "JNC adr" 10 (ThreeBytes MachineInstructions.jnc) )
        ...
        , ( 0xE2, OpCodeData "JPO adr" 10 (ThreeBytes MachineInstructions.jpo) )
        ...
        , ( 0xEA, OpCodeData "JPE adr" 10 (ThreeBytes MachineInstructions.jpe) )
        ...
        , ( 0xF2, OpCodeData "JP adr" 10 (ThreeBytes MachineInstructions.jp) )
        ...
        , ( 0xFA, OpCodeData "JM adr" 10 (ThreeBytes MachineInstructions.jm) )
