...
opCodeTable =
    Dict.fromList
        ...
        , ( 0x10, OpCodeData "-" (OneByte unknownInstruction) )
        ...
        , ( 0x13, OpCodeData "INX D" (OneByte MachineInstructions.inx_d) )
        ...
        , ( 0x19, OpCodeData "DAD D" (OneByte MachineInstructions.dad_d) )
        , ( 0x1A, OpCodeData "LDAX D" (OneByte MachineInstructions.ldax_d) )
        ...
        , ( 0x31, OpCodeData "LXI SP, D16" (ThreeBytes MachineInstructions.lxi_sp_d16) )
        , ( 0x32, OpCodeData "STA adr" (ThreeBytes MachineInstructions.sta) )
        ...
        , ( 0x36, OpCodeData "MVI M,D8" (TwoBytes MachineInstructions.mvi_m_d8) )
        ...
        , ( 0x3A, OpCodeData "LDA adr" (ThreeBytes MachineInstructions.lda) )
        ...
        , ( 0x3E, OpCodeData "MVI A,D8" (TwoBytes MachineInstructions.mvi_a_d8) )
        ...
        , ( 0x56, OpCodeData "MOV D,M" (OneByte MachineInstructions.mov_d_m) )
        ...
        , ( 0x5E, OpCodeData "MOV E,M" (OneByte MachineInstructions.mov_e_m) )
        ...
        , ( 0x66, OpCodeData "MOV H,M" (OneByte MachineInstructions.mov_h_m) )
        ...
        , ( 0x77, OpCodeData "MOV M,A" (OneByte MachineInstructions.mov_m_a) )
        ...
        , ( 0x7E, OpCodeData "MOV A,M" (OneByte MachineInstructions.mov_a_m) )
        ...
        , ( 0xA7, OpCodeData "ANA A" (OneByte MachineInstructions.ana_a) )
        ...
        , ( 0xAF, OpCodeData "XRA A" (OneByte MachineInstructions.xra_a) )
        ...
        , ( 0xC1, OpCodeData "POP B" (OneByte MachineInstructions.pop_b) )
        , ( 0xC2, OpCodeData "JNZ adr" (ThreeBytes MachineInstructions.jnz) )
        ...
        , ( 0xCD, OpCodeData "CALL adr" (ThreeBytes MachineInstructions.call) )
