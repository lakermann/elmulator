...
opCodeTable =
    Dict.fromList
        ...
        , ( 0x07, OpCodeData "RLC" 4 (OneByte unimplementedInstructionZero) )
        , ( 0x08, OpCodeData "-" 0 (OneByte unknownInstruction) )
        , ( 0x09, OpCodeData "DAD B" 10 (OneByte MachineInstructions.dad_b) )
        , ( 0x0A, OpCodeData "LDAX B" 7 (OneByte unimplementedInstructionZero) )
        ...
        , ( 0x13, OpCodeData "INX D" 5 (OneByte unimplementedInstructionZero) )
        , ( 0x14, OpCodeData "INR D" 5 (OneByte unimplementedInstructionZero) )
        , ( 0x15, OpCodeData "DCR D" 5 (OneByte unimplementedInstructionZero) )
        , ( 0x16, OpCodeData "MVI D, D8" 7 (TwoBytes unimplementedInstructionOne) )
        , ( 0x17, OpCodeData "RAL" 4 (OneByte unimplementedInstructionZero) )
        , ( 0x18, OpCodeData "-" 0 (OneByte unknownInstruction) )
        , ( 0x19, OpCodeData "DAD D" 10 (OneByte unimplementedInstructionZero) )
        , ( 0x1A, OpCodeData "LDAX D" 7 (OneByte unimplementedInstructionZero) )
        ...
        , ( 0x1F, OpCodeData "RAR" 4 (OneByte unimplementedInstructionZero) )
        , ( 0x20, OpCodeData "RIM" 4 (OneByte unimplementedInstructionZero) )
        , ( 0x21, OpCodeData "LXI H,D16" 10 (ThreeBytes unimplementedInstructionTwo) )
        , ( 0x22, OpCodeData "SHLD adr" 16 (ThreeBytes unimplementedInstructionTwo) )
        , ( 0x23, OpCodeData "INX H" 5 (OneByte unimplementedInstructionZero) )
        , ( 0x24, OpCodeData "INR H" 5 (OneByte unimplementedInstructionZero) )
        , ( 0x25, OpCodeData "DCR H" 5 (OneByte unimplementedInstructionZero) )
        , ( 0x26, OpCodeData "MVI H,D8" 7 (TwoBytes unimplementedInstructionOne) )
        , ( 0x27, OpCodeData "DAA" 4 (OneByte unimplementedInstructionZero) )
        , ( 0x28, OpCodeData "-" 0 (OneByte unknownInstruction) )
        , ( 0x29, OpCodeData "DAD H" 10 (OneByte unimplementedInstructionZero) )
        , ( 0x2A, OpCodeData "LHLD adr" 16 (ThreeBytes unimplementedInstructionTwo) )
        ...
        , ( 0x31, OpCodeData "LXI SP, D16" 10 (ThreeBytes unimplementedInstructionTwo) )
        , ( 0x32, OpCodeData "STA adr" 13 (ThreeBytes unimplementedInstructionTwo) )
        ...
        , ( 0x35, OpCodeData "DCR M" 10 (OneByte unimplementedInstructionZero) )
        , ( 0x36, OpCodeData "MVI M,D8" 10 (TwoBytes unimplementedInstructionOne) )
        , ( 0x37, OpCodeData "STC" 4 (OneByte unimplementedInstructionZero) )
        , ( 0x38, OpCodeData "-" 0 (OneByte unknownInstruction) )
        , ( 0x39, OpCodeData "DAD SP" 10 (OneByte unimplementedInstructionZero) )
        , ( 0x3A, OpCodeData "LDA adr" 13 (ThreeBytes unimplementedInstructionTwo) )
        ...
        , ( 0x3D, OpCodeData "DCR A" 5 (OneByte unimplementedInstructionZero) )
        , ( 0x3E, OpCodeData "MVI A,D8" 7 (TwoBytes unimplementedInstructionOne) )
        ...
        , ( 0x46, OpCodeData "MOV B,M" 7 (OneByte unimplementedInstructionZero) )
        ...
        , ( 0x4F, OpCodeData "MOV C,A" 5 (OneByte unimplementedInstructionZero) )
        ...
        , ( 0x56, OpCodeData "MOV D,M" 7 (OneByte unimplementedInstructionZero) )
        , ( 0x57, OpCodeData "MOV D,A" 5 (OneByte unimplementedInstructionZero) )
        ...
        , ( 0x5E, OpCodeData "MOV E,M" 7 (OneByte unimplementedInstructionZero) )
        , ( 0x5F, OpCodeData "MOV E,A" 5 (OneByte unimplementedInstructionZero) )
        ...
        , ( 0x66, OpCodeData "MOV H,M" 7 (OneByte unimplementedInstructionZero) )
        , ( 0x67, OpCodeData "MOV H,A" 5 (OneByte unimplementedInstructionZero) )
        ...
        , ( 0x6F, OpCodeData "MOV L,A" 5 (OneByte unimplementedInstructionZero) )
        ...
        , ( 0x77, OpCodeData "MOV M,A" 7 (OneByte unimplementedInstructionZero) )
        , ( 0x78, OpCodeData "MOV A,B" 5 (OneByte unimplementedInstructionZero) )
        , ( 0x79, OpCodeData "MOV A,C" 5 (OneByte unimplementedInstructionZero) )
        , ( 0x7A, OpCodeData "MOV A,D" 5 (OneByte unimplementedInstructionZero) )
        , ( 0x7B, OpCodeData "MOV A,E" 5 (OneByte unimplementedInstructionZero) )
        , ( 0x7C, OpCodeData "MOV A,H" 5 (OneByte unimplementedInstructionZero) )
        , ( 0x7D, OpCodeData "MOV A,L" 5 (OneByte unimplementedInstructionZero) )
        , ( 0x7E, OpCodeData "MOV A,M" 7 (OneByte unimplementedInstructionZero) )
        , ( 0x7F, OpCodeData "MOV A,A" 5 (OneByte unimplementedInstructionZero) )
        , ( 0x80, OpCodeData "ADD B" 4 (OneByte unimplementedInstructionZero) )
        ...
        , ( 0xA7, OpCodeData "ANA A" 4 (OneByte unimplementedInstructionZero) )
        ...
        , ( 0xAF, OpCodeData "XRA A" 4 (OneByte unimplementedInstructionZero) )
        , ( 0xB0, OpCodeData "ORA B" 4 (OneByte unimplementedInstructionZero) )
        ...
        , ( 0xC1, OpCodeData "POP B" 10 (OneByte unimplementedInstructionZero) )
        , ( 0xC2, OpCodeData "JNZ adr" 10 (ThreeBytes unimplementedInstructionTwo) )
        ...
        , ( 0xC6, OpCodeData "ADI D8" 7 (TwoBytes unimplementedInstructionOne) )
        , ( 0xC7, OpCodeData "RST 0" 11 (OneByte unimplementedInstructionZero) )
        , ( 0xC8, OpCodeData "RZ" 11 (OneByte unimplementedInstructionZero) )
        , ( 0xC9, OpCodeData "RET" 10 (OneByte unimplementedInstructionZero) )
        , ( 0xCA, OpCodeData "JZ adr" 10 (ThreeBytes unimplementedInstructionTwo) )
        , ( 0xCB, OpCodeData "-" 0 (OneByte unknownInstruction) )
        , ( 0xCC, OpCodeData "CZ adr" 10 (ThreeBytes unimplementedInstructionTwo) )
        , ( 0xCD, OpCodeData "CALL adr" 17 (ThreeBytes unimplementedInstructionTwo) )
        ...
        , ( 0xD1, OpCodeData "POP D" 10 (OneByte unimplementedInstructionZero) )
        ...
        , ( 0xD5, OpCodeData "PUSH D" 11 (OneByte unimplementedInstructionZero) )
        ...
        , ( 0xE1, OpCodeData "POP H" 10 (OneByte unimplementedInstructionZero) )
        ...
        , ( 0xE5, OpCodeData "PUSH H" 11 (OneByte unimplementedInstructionZero) )
        , ( 0xE6, OpCodeData "ANI D8" 7 (TwoBytes unimplementedInstructionOne) )
        ...
        , ( 0xEB, OpCodeData "XCHG" 5 (OneByte unimplementedInstructionZero) )
        ...
        , ( 0xF1, OpCodeData "POP PSW" 10 (OneByte unimplementedInstructionZero) )
        ...
        , ( 0xFB, OpCodeData "EI" 4 (OneByte unimplementedInstructionZero) )
        , ( 0xFC, OpCodeData "CM adr" 17 (ThreeBytes unimplementedInstructionTwo) )
        , ( 0xFD, OpCodeData "-" 0 (OneByte unknownInstruction) )
        , ( 0xFE, OpCodeData "CPI D8" 7 (TwoBytes unimplementedInstructionOne) )
